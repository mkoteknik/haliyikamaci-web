<?php
/**
 * Halı Yıkamacı - Müşteri Şifre Sıfırlama
 * 3 Aşamalı: Telefon → OTP Doğrulama → Yeni Şifre
 */

require_once '../config/app.php';
$pageTitle = 'Şifremi Unuttum - Müşteri';
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            <div class="text-center flex-fill step-item active" id="step1Indicator">
    ...
    async function handleSendOtp(db) {
        ...
        try {
            ...
            if (userData.userType !== 'customer') {
                showLoading(false);
                showError('step1Error', 'Bu numara müşteri hesabı değil. Firma şifre sıfırlama için firma sayfasını kullanın.');
                return;
            }
