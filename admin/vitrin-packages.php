<?php
/**
 * Halı Yıkamacı - Admin Vitrin Paketleri
 */

require_once '../config/app.php';
$pageTitle = 'Vitrin Paketleri';
?>
<!DOCTYPE html>
<html lang="tr">
    ...
    <div id="mainLayout" style="display: none;">
        ...
        <div class="main-content">
            <div class="d-lg-none bg-dark text-white p-3 d-flex justify-content-between align-items-center">
                ...
                <span class="fw-bold">Vitrin Paketleri</span>
                <div></div>
            </div>

            <div class="page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-ad me-2"></i>Vitrin Paketleri</h4>
            ...
            <div class="page-body">
                <div class="alert alert-info mb-4">
                    ...
                    Vitrin paketleri, firmaların ana sayfada öne çıkmasını sağlar. Firmalar KRD bakiyelerinden bu
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="packageModalTitle">Yeni Vitrin Paketi</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="packageName" class="form-control" required
                                placeholder="Örn: 7 Günlük Vitrin">
                        </div>
    ...
    <script type="module">
        ...
        function renderPackages() {
            ...
            <div class="col-12 text-center py-5">
                ...
                <h5>Henüz vitrin paketi eklenmemiş</h5>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-sm ${pkg.isPopular ? 'border-primary border-2' : ''}">
                ...
                <div class="card-body text-center">
                    <h5>${pkg.name}</h5>
                    <div class="my-3">
                        <span class="display-4 fw-bold text-primary">${pkg.days}</span>
    ...
    `).join('');
        ...
        function setupForm() {
            document.getElementById('addPackageBtn').addEventListener('click', () => {
                ...
                document.getElementById('packageModalTitle').textContent = 'Yeni Vitrin Paketi';
            ...
            document.getElementById('packageForm').addEventListener('submit', async (e) => {
                ...
                const data = {
                    ...
                    days: parseInt(document.getElementById('packageDays').value),
                ...
                try {
                    if (editingPackageId) {
                        await updateDoc(doc(db, 'vitrinPackages', editingPackageId), data);
                    } else {
                        data.createdAt = new Date();
                        await addDoc(collection(db, 'vitrinPackages'), data);
                    }
        ...
        function editPackage(packageId) {
            ...
            document.getElementById('packageModalTitle').textContent = 'Vitrin Paketi Düzenle';
            document.getElementById('packageName').value = pkg.name;
            document.getElementById('packageDays').value = pkg.days;
        ...
        async function deletePackage(packageId) {
            ...
            try {
                await deleteDoc(doc(db, 'vitrinPackages', packageId));
                await loadPackages();
            } catch (error) {
                alert('Hata: ' + error.message);
            }
